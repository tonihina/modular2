$(document).ready(function() {
  ...
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/json_ejercicios_mi_estado.php",
    cache: false,
...
$(document).ready(function() {
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/miRutina.php",
    cache: false,
...
function rutinaDe(musculo){
  ...
  $.ajax({
      type: "POST",
      url: "http://192.168.1.76/php/rutinaAleatoria.php",
      cache: false,
...
function circuito(ejercicios){
  ...
  $.ajax({
      type: "POST",
      url: "http://192.168.1.76/php/realizarEjercicio.php",
      cache: false,
...
function subirCircuito() {
  ...
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/subirCircuito.php",
    cache: false,
    crossDomain: true,
    data: dataString,
    beforeSend: function() {
