$(document).ready(function() {
    $.ajax({
            type: "POST",
            url: "http://192.168.1.76/php/mostrarComunidad.php",
            cache: false,
...
function mensajea(destinatario){
  ...
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/yalolei.php",
    cache: false,
...
$("#enviarMensaje").click(function(){
  ...
  $.ajax({
    type:"POST",
    url: "http://192.168.1.76/php/mandarMensaje.php",
    data: dataString,
    crossDomain: true,
    cache: false,
    beforeSend: function() {
...
$("#mensajes").on("pageshow", function(){ 
  ...
  $.ajax({
  type: "POST",
  url: "http://192.168.1.76/php/mostrarMensajes.php",
  cache: false,
...
function refrescar(){
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/mensajes.php",
    cache: false,
    data: "nombre="+localStorage.getItem("nombre"),
    ...
    $.ajax({
            type: "POST",
            url: "http://192.168.1.76/php/mensajesPanel.php",
            cache: false,
            data: "nombre="+localStorage.getItem("nombre"),
            beforeSend: function() {
