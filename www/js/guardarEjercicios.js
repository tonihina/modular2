function flexiones(){
    ...
    $.ajax({
        type:"POST",
        url: "http://192.168.1.76/php/actualizaFlexiones.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
...
function sentadillas(){
    ...
    $.ajax({
        type:"POST",
        url: "http://192.168.1.76/php/actualizaSentadillas.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
...
function abdominales(){
    ...
    $.ajax({
        type:"POST",
        url: "http://192.168.1.76/php/actualizaAbdominales.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
...
function fondos(){
    ...
    $.ajax({
        type:"POST",
        url: "http://192.168.1.76/php/actualizaFondos.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
