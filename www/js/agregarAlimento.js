...
$(function(){
    $("#guardarAlimento").click(function(){
      ...
      $.ajax({
        type:"POST",
        url: "http://192.168.1.76/php/insertarComida.php",
        data: dataString,
        crossDomain: true,
        cache: false,
        beforeSend: function() {
  ...
  $.ajax({
          type: "POST",
          url: "http://192.168.1.76/php/caloriasTotales.php",
  ...
  $.ajax({
      type: "POST",
      url: "http://192.168.1.76/php/contarMacrosDiarios.php",
      data: macrosTodo,
      cache: false,
      beforeSend: function() {
  ...
  $.ajax({
          type: "POST",
          url: "http://192.168.1.76/php/contarCalorias.php",
          data: dataString,
          cache: false,
          beforeSend: function() {
  ...
  $.ajax({
      type: "POST",
      url: "http://192.168.1.76/php/contadorMacros.php",
      data: macrosD,
      cache: false,
      beforeSend: function() {
...
$.ajax({
      type: "POST",
      url: "http://192.168.1.76/php/detalleDesayuno.php",
...
$.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/macrosTotalesGrafica.php",
...
$.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/macrosComidasGrafica.php",
