$(function(){
  $("#guardardatos").click(function(){
    ...
    $.ajax({
      type:"POST",
      url: "http://192.168.1.76/php/insertar.php",
      data: dataString,
      crossDomain: true,
      cache: false,
      beforeSend: function() {
  ...
  $(function(){
      $('form').submit(function(){
          ...
          $.ajax({
              ...
              url: 'http://192.168.1.76/php/conexion.php',
              success: function(data){
                  console.log(data);
...
$(document).ready(function(){
  $("#botonLogin").click(function(){
      ...
      var fpeso = $("#peso").val();
      $.post("http://192.168.1.76/php/conexion.php",{ nombre: fnombre, edad: fedad, altura: faltura, sexo: fsexo, 
  ...
  $(function(){
    $("#entrarCuenta").click(function(){
      ...
      $.ajax({
        type:"POST",
        url: "http://192.168.1.76/php/login.php",
        data: dataString,
        dataType:"JSON",
        crossDomain: true,
        cache: false,
