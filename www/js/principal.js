$(document).ready(function() {
  ...
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/mostrarImagen.php",
    cache: false,
...
$(document).ready(function() {
  ...
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/mostrarPublicaciones.php",
    cache: false,
    beforeSend: function() {
...
$(document).ready(function() {
  ...
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/mostrarRetos.php",
    cache: false,
    success: function(response)
    {
...
$(function(){
  $("#botonPublicarHistoria").on("click", function(){
      ...
      var ruta = "http://192.168.1.76/php/subirHistoria.php";
      $.ajax({
          url: ruta,
          type: "POST",
          data: formData,
...
$(function(){
  $("#botonPublicar").on("click", function(){
    ...
    var ruta = "http://192.168.1.76/php/subirPublicacion.php";
...
$(document).ready(function() {
  $.ajax({
          type: "POST",
          url: "http://192.168.1.76/php/mostrarHistorias.php",
          cache: false,
...
function detalleHistoria(usuario){
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/mostrarDetalleHistoria.php",
    cache: false,
    data: "nombre="+usuario,
    beforeSend: function() {
...
var items = [
    {
        src: 'http://192.168.1.76/php/historias/'+data[i].imagen,
        w: 600,
        h: 400
    }
];
