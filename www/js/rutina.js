...
function getEjerciciosMiEstado(){
  $.ajax({
    type: "POST",
    url: "http://192.168.1.76/php/mostrarEstadoEjercicios.php",
    cache: false,
...
function getEjercicios() {
  ...
  var url_ = "http://192.168.1.76/php/mostrarTodosEjercicios.php";
  $.ajax({
    type: "GET",
    url: url_,
    success: function(response){
...
function getRecomendaciones(arr_ejercicios) {
  var url_ = "http://192.168.1.76/php/mostrarUserEjercicios.php";
  $.ajax({
    type: "GET",
    url: url_,
    success: function(response){
...
function setEjerciciosRecom(ejercicios_recomendar){
	...
	var url_ = "http://192.168.1.76/php/mostrarCircuito.php";
  $.ajax({
    type: "POST",
    url: url_,
    dataType: "json",
...
function showRecomendaciones(ejercicios_recomendar) {
  ...
  if(ejercicios_verdaderos.length > 8){
    ...
    for (let i = 1; i < 8; i++) {
      $.ajax({
        type: "POST",
        url: "http://192.168.1.76/php/RecomendacionRutina.php",
        cache: false,
  ...
  if(ejerciciosCadena==""){
    if(ejercicios_verdaderos.length > 8)
    {
      for (let i = 1; i < 8; i++)
      {
        $.ajax({
          type: "POST",
          url: "http://192.168.1.76/php/crearCircuito.php",
          dataType: "json",
          cache: false,
          ...
          success: function(data)
          {
            ...
            if(i==7){
              ...
              $.ajax({
                type: "POST",
                url: "http://192.168.1.76/php/RealizarRutina.php",
                cache: false,
